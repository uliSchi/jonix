 ...
 * @see <a href="https://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_49.html#codelist28">ONIX
...
public enum AudienceTypes implements OnixCodelist, CodeList28 {
    ...
    /**
     * Equivalent to UNESCO's ISCED Level 0 - see http://uis.unesco.org/en/topic/international-standard-classification-education-isced
     * (note codes 11-14 are specific subsets of the Primary and secondary education audience, code 04). For use in ONIX
     * 3.0 only
     * <p>
    ...
    /**
     * For tertiary education typically in universities and colleges of higher education, equivalent to ISCED Levels
     * 5-7
     * <p>
     * Jonix-Comment: Introduced in Onix3
     */
     ...
     * Jonix-Comment: Deprecated in Onix3
     */
    Second_language_teaching_("09", "Second language teaching");
